...
using Preset_Maintenance.jartrekDataSetTableAdapters;
using PriorityControl;
...
namespace PriorityControl
{
    public partial class PresetPriorityControl : UserControl
    {
        ...
        public IEnumerable<MyPresetButton> PriorityButtons
        {
            get
            {
                return Controls["Preset_GroupBox"].Controls["PresetPanel"].Controls.OfType<MyPresetButton>();
            }
        }
        ...
        //    var presets = GetPresetPriority((CurrentRow.Row as jartrekDataSet.PresetMasterRow).KeyCode);
        ...
        //            btn.PresetButton.Image = GetBitMaps(VirtualPreset.PresetCode, VirtualPreset.PresetPicture);
        //        }
        //    }
        //}
        ...
        private void Btn_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            else if (e.Button == MouseButtons.Left)
            {
                ...
                if (effect == DragDropEffects.Move && originalButton.Tag != newButton)
                {
                    ...
                    originalButton.Image = GetBitMaps(originalBitMap);
